...
tf.flags.DEFINE_string("training_files", "deep-siamese-text-similarity/person_match.train2", "training file (default: None)")  #for sentence semantic similarity use "train_snli.txt"
